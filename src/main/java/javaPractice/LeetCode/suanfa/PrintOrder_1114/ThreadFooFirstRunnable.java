...
public class ThreadFooFirstRunnable implements Runnable {
...
//    }
    ...
    public ThreadFooFirstRunnable(String message, Foo foo) {
        this.message = message;
        this.foo = foo;
//        System.out.println(message);
    }

    public ThreadFooFirstRunnable(String message, FooSemaphore fooSemaphore) {
        this.message = message;
