...
public class ThreadFooThirdRunnable implements Runnable {
...
//    }
    ...
    public ThreadFooThirdRunnable(String message, Foo foo) {
        this.message = message;
        this.foo = foo;
//        System.out.println(message);
    }

    public ThreadFooThirdRunnable(String message, FooSemaphore fooSemaphore) {
        this.message = message;
